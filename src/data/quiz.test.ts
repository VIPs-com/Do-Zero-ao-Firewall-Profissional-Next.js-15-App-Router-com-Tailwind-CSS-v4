...
describe('AVANCADOS_QUESTIONS', () => {
  it('tem exatamente 105 questões', () => { expect(AVANCADOS_QUESTIONS).toHaveLength(105); });
...
describe('QUIZ_QUESTIONS (barrel)', () => {
  it('total = 278 (105 + 68 + 105)', () => { expect(QUIZ_QUESTIONS).toHaveLength(278); });
