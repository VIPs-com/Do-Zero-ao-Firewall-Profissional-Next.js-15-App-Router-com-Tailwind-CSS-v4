...
// Sequência linear dos 21 módulos do curso — usada pelo ModuleNav para navegação Anterior/Próximo.
...
export const COURSE_ORDER: CourseModule[] = [
  ...
  { path: '/fail2ban',          title: 'Fail2ban',                   prev: '/nftables',          next: '/audit-logs' },
  { path: '/audit-logs',        title: 'Audit & Logs',               prev: '/fail2ban',          next: '/ataques-avancados' },
