...
export const BADGE_DEFS: Record<BadgeId, BadgeDef> = {
  ...
  'deep-diver':         { icon: '🤿', title: 'Mergulhador',        desc: 'Visitou todas as 77 páginas de conteúdo — os módulos das 3 trilhas' },
  ...
  'fundamentos-master': { icon: '🐧', title: 'Fundamentos Master',    desc: 'Completou todos os 17 módulos da Trilha Fundamentos Linux' },
