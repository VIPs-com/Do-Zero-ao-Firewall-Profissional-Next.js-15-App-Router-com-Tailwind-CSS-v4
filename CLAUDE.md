...
npm run test         # vitest run — 13 suítes · 178 testes (BadgeContext, ClientLayout, GlobalSearch, SEO, courseOrder, ModuleNav, srs, topicos, useTabFilter, quiz, searchItems, migrations, incidents)
