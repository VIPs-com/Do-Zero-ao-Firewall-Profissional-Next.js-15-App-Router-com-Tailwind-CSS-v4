...
|-----------|---------|-------|
| `CONTENT_PAGES_COUNT` | `src/context/BadgeContext.tsx` | 41 (Sprint I.19: +ebpf) |
| `totalTopics` | `app/dashboard/page.tsx` | 76 (Sprint I.19: +eBPF) |
| `checklistItemsCount` | `app/dashboard/page.tsx` | 133 (Sprint I.19: +3 checkpoints ebpf) |
| Texto na Home | `app/page.tsx` | "58 tópicos práticos" + stats: 58/24/30/7 |
| Badges | `src/context/BadgeContext.tsx` | 48 (Sprint I.19: +ebpf-master) |
| searchItems | `src/data/searchItems.ts` | 125 (Sprint I.19: +2 ebpf) |
