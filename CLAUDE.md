...
src/
  ...
  data/
    quizQuestions.ts        # perguntas do quiz — 234 perguntas (firewall=92, fundamentos=60, avancados=82; Sprint QUIZ-AVANCADOS-DEPTH: +19 para profundidade da trilha Avançados)
