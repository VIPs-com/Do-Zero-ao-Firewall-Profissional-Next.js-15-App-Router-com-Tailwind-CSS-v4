...
|-----------|---------|-------|
| `CONTENT_PAGES_COUNT` | `src/context/BadgeContext.tsx` | 35 (Sprint I.13: +ldap +pihole) |
| `totalTopics` | `app/dashboard/page.tsx` | 70 (Sprint I.13: +LDAP +Pi-hole) |
| `checklistItemsCount` | `app/dashboard/page.tsx` | 115 (Sprint I.13: +6 checkpoints ldap+pihole) |
| Texto na Home | `app/page.tsx` | "58 tópicos práticos" + stats: 58/24/30/7 |
| Badges | `src/context/BadgeContext.tsx` | 42 (Sprint I.13: +ldap-master +pihole-master) |
| searchItems | `src/data/searchItems.ts` | 113 (Sprint I.13: +4 LDAP+Pi-hole) |
