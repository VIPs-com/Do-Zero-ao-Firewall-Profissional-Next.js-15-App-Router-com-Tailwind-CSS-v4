...
src/
  ...
  data/
    quizQuestions.ts        # perguntas do quiz — 243 perguntas (firewall=101, fundamentos=60, avancados=82; Sprint QUIZ-FIREWALL-DEPTH: +9 para módulos com apenas 3 questões)
