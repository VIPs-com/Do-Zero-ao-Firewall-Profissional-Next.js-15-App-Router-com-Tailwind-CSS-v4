...
- ✅ Sprint ERROS-COMUNS: seção "Erros Comuns e Soluções" (4 cards por página) adicionada a 11 módulos sem cobertura — docker, docker-compose, hardening, apache, dhcp, samba, ssh-2fa, boot, ataques-avancados, backup, pacotes. Sem mudanças em constantes.
