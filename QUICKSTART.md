...
npm test             # vitest — 8 suítes · 115 testes (BadgeContext, ClientLayout, GlobalSearch, SEO, courseOrder, ModuleNav, srs, topicos)
```
...
| `/src/data/searchItems.ts` | Índice da busca global ⌘K (223 itens) |
| `/src/data/courseOrder.ts` | COURSE_ORDER (25 módulos v1.0) + FUNDAMENTOS_ORDER (15 módulos v2.0) + ADVANCED_ORDER (20 módulos v3.0-v5.0) — usados pelo ModuleNav |
