...
npm test             # vitest — 19 suítes · 258 testes (BadgeContext, ClientLayout, GlobalSearch, SEO, courseOrder, ModuleNav, srs, topicos, quiz, searchItems, journey, migrations, incidents, cidr, regex, iptables, ps1, base64, useTabFilter)
```
...
**Sprints concluídos:** A · B · C · D · E · G · F · M · T₀/T₁ · J · I.1 · I.2 · Polish · T₂ · R · P · L · SIGMA · SIGMA Fase 2 · SIGMA Fase 3 · W · W2 · Polish (ModuleNav) · Audit Fix · V+Topics+UX · T₃ · Badge V2 · UI-H · PV · CE · CERT · ANIM · CE-E2E · EVOL · I.3 · I.4 · F1-F3 · Polish-F · I.5 · I.6 · Polish-I+Quiz++ · F4-F7 (v2.0 COMPLETO — 15 módulos) · I.7-I.13 (v3.0 COMPLETO — 10 módulos) · I.14-I.17 · I.18-I.25 (v4.0+v5.0 COMPLETOS) · SSH-PROXY · Quiz-Completo · Quiz-Fundamentos · Advanced-Trail · Advanced-Nav · PROGRESS-DROPDOWN · QUIZ-TRAIL · TOPICOS-TRAIL · AVANCADOS-INDEX · GLOSSARIO-ADVANCED · QUIZ-FIX · QUIZ-COVER · QUIZ-LATE-MODULES · QUIZ-UX · SEARCH-EXPAND · CONTENT-ATAQUES · CONTENT-PIVOTING · CONTENT-LABORATORIO · WINDOWS-POLISH · FUNDAMENTOS-WINDOWS · ERROS-COMUNS · DEEP-DIVES-V2/V3/V4 · GLOSSARIO-V2/V3 · CHEAT-V2/V3 · QUIZ-200+SCENARIOS (254 perguntas) · SEARCH-COMPLETE (220 itens) · UX-TABS · UX-PAGES · EVOLUCAO-FIX · UX-TABS-2 · UX-TABS-3 (100% abas) · Advanced-E2E · QUIZ-v2 · CHEAT-v4 · **TOPICOS-INTENT** (Épico A: toggle 📚/🔥 + tooltip hover + mobile expand + 12 testes · 69 testes) · **SRS** (Épico B: motor SM-2 puro + /treino "Treinamento Tático" + seed quiz + dashboard card · 102 testes · 56 badges · 160 checkpoints) · **UX-TABS-4** (100% páginas com 3 abas: dns/vpn-ipsec/ataques-avancados/instalacao) · **SRS-E2E** (8 casos Playwright /treino · 113 testes) · **SRS-STREAK** (badge 🔥 srs-streak-7 · 58 badges · 113 testes) · **NFS** (/nfs v3.0 módulo 8 · 58 badges · 163 checkpoints · 86 tópicos · 257 quiz) · **QUIZ-MODULO** (filtro por módulo + URL ?modulo=BADGE + chips colapsáveis · 115 testes) · **QUIZ-CTA** (botão "🎯 Quiz deste módulo" no ModuleNav · PATH_TO_QUIZ_BADGE 60 rotas · 115 testes) · **PRINT-CHEAT** (🖨️ Imprimir + @media print /cheat-sheet · todas as abas · 2 colunas) · **SPARSE-TABS-FIX** (enriquecimento /hardening aba Exercícios + /ataques-avancados aba Spoofing — Erros Comuns + Defesa em Profundidade · 115 testes) · **PERF** (useMemo BadgeContext Provider + React.memo TopicRow/TermCard + useCallback handleStart/handleAnswer/resetQuiz + filteredCommands useMemo · −70% re-renders globais · 115 testes) · **EVOL-INTERNAL** (BadgeContext API pública −2 campos: milestoneBadge/clearMilestoneBadge internalizados · E2E fix 0/57→0/58 · 115 testes) · **QUIZ-SPLIT** (quizQuestions.ts 3252 linhas → 4 arquivos: quiz/types.ts + firewall.ts 105 + fundamentos.ts 60 + avancados.ts 92 · barrel re-exporta tudo · zero mudanças em consumers · 115 testes) · **CONSOLIDACAO** (badges.ts + topics.ts extraídos de BadgeContext/page · quiz.test.ts + searchItems.test.ts · 10 suítes · 143 testes) · **E2E-TOPICOS** (e2e/13-topicos-filters · 10 casos · 13 specs) · **HOOK** (useTabFilter — hook genérico de abas aplicado em 40 páginas · 11 suítes · 157 testes) · **SEARCH-ROUTES** (67/67 rotas com busca · searchItems 229) · **FOUNDATION** (F16 /usuarios + F17 /troubleshooting · badge 🏁 ground-zero · FUNDAMENTOS_ORDER 17 módulos · 62 badges · 172 checkpoints · 89 tópicos · build 75 rotas) · **E2E-FOUNDATION** (e2e/14-foundation-modules · 11 casos) · **E2E-FULL** (e2e/15-routes-smoke · smoke das 71 rotas · fix a11y /offline) · **QUIZ-GROUND-ZERO** (hub de quiz da trilha Fundamentos em /fundamentos · +8 questões F16/F17 · QUIZ_QUESTIONS 265 · fix /ssh-proxy ModuleNav duplicado · 157 testes) · **LAYOUT-SYNC** · **E2E-HARDENING** · **CÓDICE** (/resposta-incidentes — capstone DFIR) · **FORTALEZA** (CrowdSec/Tailscale/PBS) · **GPG** (/gpg) · **PILARES** (LVM-RAID/Banco-de-Dados/Mail-Server) · **REDES-L23** (/redes-l2-l3 + /alta-disponibilidade) · **CARREIRA** (/cloud-publica + /git + /carreira) · **APROF** (7 módulos aprofundados) · **POLIMENTO** (258 testes vitest · 25 specs E2E · build 93 rotas · 76 badges · 214 checkpoints · 103 tópicos · 326 questões · 77 módulos)
