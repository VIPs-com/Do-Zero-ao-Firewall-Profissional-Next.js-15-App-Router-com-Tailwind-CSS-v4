...
const PHASE_V3 = {
  ...
  modules: [
    ...
    { name: 'Samba — File Sharing',      slug: '/samba',          available: true,  icon: '🗂️', tags: ['smb.conf', 'Windows', '\\\\IP\\pasta'] },
    ...
    { name: 'SSH como Proxy SOCKS',      slug: '/ssh-proxy',      available: true,  icon: '🚇', tags: ['-D SOCKS5', '-L/-R', 'Jump Host'] },
  ],
};
...
const PHASE_V4 = {
  ...
  modules: [
    ...
    { name: 'Terraform',              slug: '/terraform',      available: true,  icon: '🏗️',  tags: ['IaC', 'providers', 'state'] },
