...
import {
  ...
  ChevronLeft, Shield, Clock, TrendingUp, FileText, Zap, ArrowRight,
} from 'lucide-react';
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-bg-2 border border-accent/30 rounded-xl p-5">
              ...
              <div className="bg-bg-3 rounded-lg p-3 text-xs font-mono text-text-2">
                ...
                <div className="text-accent-2 mt-2">Exemplos:</div>
...
echo "Postmortem criado. Compartilhar em até 48h após o incidente."`} />
        ...
        <div className="p-6 rounded-xl bg-bg-2 border border-border mb-8">
          ...
          <p className="text-xs text-text-2 leading-relaxed mb-4">
            Entenda a matemática dos noves e como o burn rate guia decisões de deployment.
          </p>
          <button
            onClick={() => setActiveDeepDive(DEEP_DIVES.find(d => d.id === 'sre-error-budget') ?? null)}
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-text group-hover:text-accent uppercase tracking-wider">SRE — Error Budget e Burn Rate</span>
            </div>
