...
const STATS = [
  { icon: <Layers size={20} className="text-accent" />, value: '90', label: 'Tópicos práticos' },
  { icon: <BookOpen size={20} className="text-info" />, value: '64', label: 'Módulos de conteúdo' },
  { icon: <Award size={20} className="text-ok" />, value: '63', label: 'Badges desbloqueáveis' },
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-text-2 leading-relaxed mb-10 max-w-lg">
            ...
            Proxy, VPN IPSec, WireGuard e Fail2ban. <strong>90 tópicos práticos</strong> com diagnóstico por camadas OSI.
          </p>
