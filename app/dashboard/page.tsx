...
export default function DashboardPage() {
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 99) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (99/133 checkpoints)',
      current: checklistCompleted, total: 99, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
