...
export default function DashboardPage() {
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 97) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (97/130 checkpoints)',
      current: checklistCompleted, total: 97, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
