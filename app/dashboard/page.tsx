...
export default function DashboardPage() {
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 95) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (95/127 checkpoints)',
      current: checklistCompleted, total: 95, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
