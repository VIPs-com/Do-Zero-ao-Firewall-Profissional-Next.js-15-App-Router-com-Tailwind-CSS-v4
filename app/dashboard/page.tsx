...
export default function DashboardPage() {
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 104) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (104/139 checkpoints)',
      current: checklistCompleted, total: 104, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
