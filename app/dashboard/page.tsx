...
export default function DashboardPage() {
  ...
  // Sprint F1-F3: +10 módulos Fundamentos → 47+10 = 57
  ...
  // Sprint F1-F3: +10 checkpoints Fundamentos → 66+10 = 76
  const checklistItemsCount = 76;
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 57) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (57/76 checkpoints)',
      current: checklistCompleted, total: 57, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
  } else if (!unlockedBadges.has('course-master') && visitedModulesCount < 23) {
    nextMilestone = { emoji: '🎯', label: 'Mestre do Curso', description: 'Visite todos os 23 módulos do curso',
      current: visitedModulesCount, total: 23,
