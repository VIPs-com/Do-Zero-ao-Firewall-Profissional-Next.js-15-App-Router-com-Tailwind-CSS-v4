...
export default function DashboardPage() {
  ...
  // Sprint I.15: +1 tópico Monitoring → 71+1 = 72
  ...
  // Sprint I.15: +3 checkpoints Monitoring → 118+3 = 121
  const checklistItemsCount = 121;
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 90) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (90/121 checkpoints)',
      current: checklistCompleted, total: 90, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
