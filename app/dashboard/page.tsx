...
export default function DashboardPage() {
  ...
  // Sprint I.16: +1 tópico Kubernetes → 72+1 = 73
  const totalTopics = 73;
  ...
  // Sprint I.16: +3 checkpoints K8s → 121+3 = 124
  const checklistItemsCount = 124;
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 93) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (93/124 checkpoints)',
      current: checklistCompleted, total: 93, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
