...
export default function DashboardPage() {
  ...
  // Sprint I.18: +1 tópico Suricata → 74+1 = 75
  const totalTopics = 77;
  ...
  // Sprint I.18: +3 checkpoints Suricata → 127+3 = 130
  const checklistItemsCount = 136;
  ...
  if (!unlockedBadges.has('linux-ninja') && checklistCompleted < 102) {
    nextMilestone = { emoji: '🥷', label: 'Linux Ninja', description: 'Complete 75% do checklist (102/136 checkpoints)',
      current: checklistCompleted, total: 102, href: '/instalacao#checklist', cta: 'Ir para o Lab' };
