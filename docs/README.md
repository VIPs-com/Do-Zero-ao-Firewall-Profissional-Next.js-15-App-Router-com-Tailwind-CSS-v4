...
- [Gamificacao & Badges](gamificacao.md) — 77 badges · 217 checkpoints · 7 milestones · como adicionar
- [Busca Global](busca-global.md) — CMD+K, searchItems (307 itens), deep dives
- [SEO — Fonte Unica](seo.md) — ROUTE_SEO (90 rotas), buildMetadata(), sitemap, OG image, JSON-LD
...
- [Modulos Linux](modulos-linux.md) — v1.0 Firewall (25) + v2.0 Fundamentos (17) + v3.0 Servidores (9) + v4.0 Infra (9) + v5.0 Cloud (18) · rota `/jornada` une as trilhas · `/comece-aqui` é o guia de entrada

## Referencia

- [Roadmap Tecnico](roadmap.md) — histórico completo de sprints (A → SEGURANCA-PRO)
...
| Métrica | Valor |
|---------|-------|
| Rotas no build | 95 (78 páginas de conteúdo + suporte + sitemap/robots/OG/icons/manifest) |
| ROUTE_SEO | 90 rotas |
| Tópicos | 104 |
| Badges | 77 (7 milestones) |
| Checkpoints | 217 |
| Quiz (perguntas) | 330 |
| searchItems | 307 |
...
| v5.0 Cloud & Platform | 18 módulos ✅ |
