...
- **Escopo:** 106 tópicos, ~97 rotas, 79 badges, 228 checkpoints de validação · 345 questões de quiz
...
- **228 checkpoints** técnicos de validação (ALL_CHECKLIST_IDS)
- **Linux Ninja** 🥷 → completar 75% dos checkpoints (171/228)
