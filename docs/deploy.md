...
- [ ] `npm run build` — **52/52 paginas** (47 proprias + sitemap + robots + opengraph-image + icon + apple-icon + manifest + `_not-found`)
- [ ] Verificar constantes criticas (`CONTENT_PAGES_COUNT = 39`, `totalTopics = 74`, `checklistItemsCount = 127`, `badges = 46`, `searchItems = 121`)
